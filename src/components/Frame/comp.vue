...
export default {
  ...
  methods: {
    ...
    initIframe() {
      ...
      if (this.frameborder)
        this.iframeEl.setAttribute("frameborder", this.frameborder);
      ...
      if (this.allowfullscreen)
        this.iframeEl.setAttribute("allowfullscreen", this.allowfullscreen);
      if (this.scrolling)
        this.iframeEl.setAttribute("scrolling", this.scrolling);
